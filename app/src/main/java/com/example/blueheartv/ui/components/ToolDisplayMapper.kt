...
private val toolDisplaySpecs = mapOf(
    ...
    "search_files" to ToolDisplaySpec("查找会议记录", "正在查找会议记录", "已找到会议记录", ToolDisplayType.SYSTEM),
    ...
    "amap_mcp_tool" to ToolDisplaySpec("规划出行路线", "正在规划出行路线", "已完成路线规划", ToolDisplayType.SYSTEM),
